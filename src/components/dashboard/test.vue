      ...
      <div class="content">
        ...
        <div class="stats-grid">
          <div class="stat-card" v-for="stat in stats" :key="stat.label">
            <div class="stat-left">
              ...
              <p class="stat-change">
                <span class="arrow-up">↑</span> {{ stat.change }} Up from
                yesterday
              </p>
            </div>
        ...
        <div class="charts-row">
          ...
          <div class="card calendar-card">
            ...
            <div class="cal-grid">
              <div class="cal-day-name" v-for="d in dayNames" :key="d">
                {{ d }}
              </div>
              <div
          ...
          <table class="students-table">
            ...
            <tbody>
              <tr v-for="student in students" :key="student.name">
                ...
                <td>{{ student.room }}</td>
                <td>
                  <span class="badge" :class="badgeClass(student.type)">{{
                    student.type
                  }}</span>
                </td>
              </tr>
